...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name){
        ...
        opt1.setFont(new Font("Dialogue",Font.PLAIN,20));
        add(opt1);
        opt2 = new JRadioButton();
        opt2.setBounds(170,440,700,30);
        opt2.setBackground(Color.white);
        opt2.setFont(new Font("Dialogue",Font.PLAIN,20));
        add(opt2);
        opt3 = new JRadioButton();
        opt3.setBounds(170,480,700,30);
        opt3.setBackground(Color.white);
        opt3.setFont(new Font("Dialogue",Font.PLAIN,20));
        add(opt3);
        opt4 = new JRadioButton();
        opt4.setBounds(170,520,700,30);
        opt4.setBackground(Color.white);
        opt4.setFont(new Font("Dialogue",Font.PLAIN,20));
        add(opt4);
        ...
        submit.setBounds(1100,570,200,40);
    ...
    @Override
       ...
       public void paint(Graphics g){
        ...
        g.setFont(new Font("Tohma",Font.BOLD,25));
        
        if(timer>0){
            g.drawString(time,1050,410);
        } else {
            g.drawString("Times Up!!", 1150, 410);
        }
         timer--;
         try{
            Thread.sleep(1000);
     ...
     public void start (int count){
      ...
      public static void main(String args[]){
        ...
        private Font Font(String tahoma, int PLAIN, int i)
    {
